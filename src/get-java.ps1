...
Switch ("$os $arch $type") {
	...
	"Linux i686 jre" {
		$JDK_URL = "@{jre.linux.x86.url}"
		$JDK_SHA256 = "@{jre.linux.x86.sha256}"
	}
	"Linux aarch64 jre" {
		$JDK_URL = "@{jre.linux.aarch64.url}"
		$JDK_SHA256 = "@{jre.linux.aarch64.sha256}"
	}
	"Linux armv7l jre" {
		$JDK_URL = "@{jre.linux.armv7l.url}"
		$JDK_SHA256 = "@{jre.linux.armv7l.sha256}"
	}
	"Linux ppc64le jre" {
		$JDK_URL = "@{jre.linux.ppc64le.url}"
		$JDK_SHA256 = "@{jre.linux.ppc64le.sha256}"
	}	
